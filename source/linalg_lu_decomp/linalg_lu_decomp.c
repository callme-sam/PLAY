...
int linalg_lu_decomp_parallel(float *mat, int *perm, const int dim_M, const int dim_N)
{
    int dim_min;
    int id;
...
int linalg_lu_decomp_serial(float *mat, int *perm, const int dim_M, const int dim_N)
{
    float factor;
    float pivot;
    int dim_min;
...
#ifdef  CLUSTER
    ret = linalg_lu_decomp_parallel(mat, perm, dim_M, dim_N);
#else   /* CLUSTER */
    ret = linalg_lu_decomp_serial(mat, perm, dim_M, dim_N);
#endif  /* CLUSTER */
