...
def generate_header_file(length, vec, expected, filename="data.h"):
    ...
    with open(filepath, "w") as f:
        ...
        f.write(f"float expected = {format_float(expected)};\n\n")
        ...
        f.write(f"PI_L2 float expected = {format_float(expected)};\n\n")
...
def main():
    ...
    expected = elementwise_min(vec)

    generate_header_file(length, vec, expected)
