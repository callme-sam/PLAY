...
static void run_test()
{
    ...
    INIT_STATS();
    START_STATS();
    vector_scale(src, val, result, LEN);
    STOP_STATS();
...
static int test_vector_scale()
{
    ...
    printf("INFO | Running 'vector_scale' test on PULP Cluster with %d cores\n", NUM_CORES);
...
static int test_vector_scale()
{
    ...
    printf("INFO | Running 'vector_scale' test on Fabric Controller\n");
